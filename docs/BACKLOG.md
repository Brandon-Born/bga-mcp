...
- **Progress, 2026-08-10:** BGA-327 replaced the four local regexes with the shared credential rules: an own-account line carrying anything they recognize is withheld whole, and a line that is kept is passed through the same value redaction as every other successful result. BGA-320, BGA-321, BGA-322, BGA-326, and BGA-328 remain open against this capability.
