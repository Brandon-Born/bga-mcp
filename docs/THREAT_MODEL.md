...
TB-STUDIO was reviewed on 2026-08-07. The review opens file synchronization behind seven preconditions and deliberately keeps log access, test tables, saved states, and player perspectives closed — there is no documented interface for any of them, and production logs carry player identifiers. See the [Studio boundary review](verification/STUDIO_BOUNDARY_REVIEW.md).
