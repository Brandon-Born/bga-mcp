...
- **Verified commit:** `f2a90a729875de49e0d946fe53aae8695570b09e`
...
| Hosted CI matrix      | [CI run 31098519365](https://github.com/Brandon-Born/bga-mcp/actions/runs/31098519365) passed all six Ubuntu, macOS, and Windows jobs on Node 22 and 24. The [controlled failure proof](CI_FAILURE_PROOF.md) records an isolated hosted failure for every required command. |
